local BOs = import('/mods/AlphaSwarm/lua/AI/AlphaSwarm/BuildOrders.lua')
...
IntelManager = Class({
    ...
    LoadMapMarkers = function(self)
        self.gap = ScenarioInfo.AlphaSwarmMap.gap
        self.xOffset = ScenarioInfo.AlphaSwarmMap.xOffset
        self.zOffset = ScenarioInfo.AlphaSwarmMap.zOffset
        self.xNum = ScenarioInfo.AlphaSwarmMap.xNum
        self.zNum = ScenarioInfo.AlphaSwarmMap.zNum
        -- Get our own copy of this since we migth want to edit fields in here
        self.markers = table.deepcopy(ScenarioInfo.AlphaSwarmMap.markers)
    end,

--[[
    Documentation on what unit CustomData fields are used by AlphaSwarm, and what they mean.
    ...
    CustomData.landAssigned
        True when assigned to a land controller

    CustomData.airAssigned
        True when assigned to a air controller

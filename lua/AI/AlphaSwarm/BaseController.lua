local TroopFunctions = import('/mods/AlphaSwarm/lua/AI/AlphaSwarm/TroopFunctions.lua')
local Translation = import('/mods/AlphaSwarm/lua/AI/AlphaSwarm/FactionCompatibility.lua').translate
local CreatePriorityQueue = import('/mods/AlphaSwarm/lua/AI/AlphaSwarm/PriorityQueue.lua').CreatePriorityQueue
...
BaseController = Class({
    ...
    -- Function For Below Subjects within "RunMobileJobThread" and later Functions
